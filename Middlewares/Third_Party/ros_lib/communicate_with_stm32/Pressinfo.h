#ifndef _ROS_communicate_with_stm32_Pressinfo_h
#define _ROS_communicate_with_stm32_Pressinfo_h
...
namespace communicate_with_stm32
{
  ...
  class Pressinfo : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "communicate_with_stm32/Pressinfo"; };
