#ifndef _ROS_ydlidar_ros_driver_LaserFan_h
#define _ROS_ydlidar_ros_driver_LaserFan_h
...
namespace ydlidar_ros_driver
{
  ...
  class LaserFan : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "ydlidar_ros_driver/LaserFan"; };
    virtual const char * getMD5() override { return "be4554a7f739c3325c744fb261ecf7eb"; };
